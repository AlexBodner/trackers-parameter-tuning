<h1> Extracted YOLOX detections for the <u>SportsMOT</u> dataset </h1>

Related notebooks:
<ul> 
<li>ByteTrack runs on SportsMOT sequences: <a href="https://colab.research.google.com/drive/1Xxq2gIme0t_gDb5u6FRy8bqFx6mBN2Ta">link</a></i>
<li>ByteTrack evaluation on SportsMOT sequences: <a href="https://colab.research.google.com/drive/1EVHOAakZ4lG811tZv4F_NQy183t8nePx">link</a></i>
</ul>
...
SportsMOT train, val and test: `-f exps/example/mot/yolox_x_mix_det.py -c pretrained/yolox_x_sports_mix.pth.tar` <br/> <br/>
<br/>
E.g. for DanceTrack test set, a single sequence detection extracting command would be:<br/>

`python3 tools/demo_track__only_save_dets.py image -f exps/example/mot/yolox_x_mix_det.py -c pretrained/yolox_x_sports_mix.pth.tar --fp16 --conf 0.01 --nms 0.7 --path /my_dir/datasets/sportsmot_publish/dataset/test/v_1UDUODIBSsc_c001/img1`

<h2> Pre-trained models </h2>
The pre-trained detection models are available here:<br/>
<a href="https://github.com/MCG-NJU/MixSort?tab=readme-ov-file#model-zoo">SportsMOT</a> - yolox_x_sports_mix.pth.tar: yolox_x_sports_mix.pth.tar<br/>
